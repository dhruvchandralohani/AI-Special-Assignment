...
# 2-bit by 2-bit binary multiplier					Multiplicand bits are b1 and b0,
multiply(a0, a1, b0, b1, c3, c2, c1, c0):-				#the multiplier bits are a1 and a0,
and(a0, b0, c0),							#and the product iss c3c2c1c0.
and(a0, b1, X1),
and(a1, b0, Y1),
and(a1, b1, X2),
half_adder(X1, Y1, c1, Y2),
half_adder(X2, Y2, c2, c3).
